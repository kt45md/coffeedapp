...
#snippet to allow photo uploads created by Eric Neuman
...
class Location(models.Model):
	...
	def get_average_rating(self):
		...
		#review_set is created by Django when ForeignKey(user) is used. 
		#This line takes all the rating and delivers an average
		if average == None:
			return average
		else:
			return int(average)
